...
namespace aed {
  ...
  //---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>
  // Make the values of the btree unique (as in a set).
  // Eventually increments the values of the nodes
  void make_unique(btree<int> &T);
  void make_unique(btree<int> &T,btree<int>::iterator n,set<int> &vals);
