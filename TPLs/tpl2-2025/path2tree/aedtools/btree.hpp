...
namespace aed {
  ...
  public:
    ...
    // Not possible to overload by left-valueness
    // iterator splice(iterator to,const iterator from) {
    //   auto f=from;
    //   return splice(to,f);
    // } 
    // -------------------------------------------------------------
    ...
    // -------------------------------------------------------------
    void swap(btree<T> &T2) { cell *aux=header; header=T2.header; T2.header=aux; }
  // -------------------------------------------------------------
  }; // end class btree
  template <class T>
