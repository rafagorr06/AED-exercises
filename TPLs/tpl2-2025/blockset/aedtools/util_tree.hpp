...
namespace aed {
  ...
  //---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>
  // Fill tree with random ID in [0,nnodes)
  void fill_ids(tree<int> &T);
  
  //---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>
  // Apply a scalar function to each element of the tree
  // With polymorfism
  class scalarfunc_t {
  public:
  ...
  void tree2dot(tree<int> &T,const char *file,
                std::map<int,std::string> &id2key);
  void parsetreeline(std::string &line,std::string &newline,
                     std::map<int,std::string> &id2key);
