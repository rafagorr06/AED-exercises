// GITVERSION: aed-2021-329-g523f5729
...
void aed::check_dni() {
  ...
  for (auto &z : dnis) 
    if (DNI == z) { ok=1; break; }
  if (!ok)
    cout << "NO SE ENCONTRO EL DNI " << DNI << "  EN LA BASE! "
      "COMPLETAR CON EL DNI DEL ALUMNO!!" << endl;
#else
  throw logic_error("Version compiled for library");
#endif

#if 0  
  //---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>
  bool quateq(quat_t &q1,quat_t &q2,double tol=1e-10) {
...
double aed::eval_base_t::BGDUMMY=0.0;
